...
<tabset type="pills">
	 <tab>
	 	 <tab-heading>
			<i class="fa fa-edit"></i> Specifications
		 </tab-heading>
		 <div ng-form="editProjectideaForm" class="form-horizontal">
			<alert ng-repeat="alert in alerts" type="{{alert.type}}"
				close="closeAlert($index)">{{alert.msg}}</alert>
			<div class="form-group">
				<label for="title" class="col-md-2 control-label">Title</label>
				<div class="col-sm-10">
					<input ng-model="projectIdeaDraft.title" type="text"
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input class="form-control" ui-select2="select2Options"
						placeholder="Tags" ng-model="projectIdeaDraft.tags"
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<select class="form-control" ng-model="projectIdeaDraft.years">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<select class="form-control" ng-model="projectIdeaDraft.months">
						<option value="0">0</option>
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<select class="form-control" ng-model="projectIdeaDraft.days">
						<option value="0">0</option>
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
			...
			<div class="form-group">
				<div class="col-md-offset-2 col-md-10">
					<button type="button" ng-if="editProjectideaForm.$dirty"
						...
						ng-click="editProjectideaForm.$valid && saveDraft(projectIdeaDraft)">Update</button>
	...
	<tab>
		<tab-heading>
			<i class="fa fa-file-text"></i> Attachments
		</tab-heading>
		<!-- Alert messages -->
		<alert ng-repeat="alert in alerts" type="{{alert.type}}"
			close="closeAlert($index)"> {{alert.msg}} </alert>
		<!-- New Document Form -->
		<form name="projectIdeaDocumentForm" class="form-horizontal">
